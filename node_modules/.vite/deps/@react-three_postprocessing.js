...
var seed = function seed2(_seed) {
  ...
  for (var i = 0; i < 256; i++) {
    ...
    perm[i] = perm[i + 256] = v4;
    gradP[i] = gradP[i + 256] = grad3[v4 % 12];
  }
};
seed(0);
...
var perlin3 = function perlin32(x, y, z2) {
  ...
  var v4 = fade(y);
  var w2 = fade(z2);
  return lerp(lerp(lerp(n000, n100, u), lerp(n001, n101, u), w2), lerp(lerp(n010, n110, u), lerp(n011, n111, u), w2), v4);
};
...
var dt = (0, import_react.memo)((0, import_react.forwardRef)(({ children: e, camera: t, scene: o, resolutionScale: r, enabled: a = true, renderPriority: n = 1, autoClear: i = true, depthBuffer: s, enableNormalPass: l, stencilBuffer: p2, multisampling: _ = 8, frameBufferType: S = HalfFloatType }, g) => {
  const { gl: d, scene: m2, camera: v4, size: x } = useThree(), f = o || m2, u = t || v4, [c2, U, b] = (0, import_react.useMemo)(() => {
  ...
  (0, import_react.useEffect)(() => c2 == null ? void 0 : c2.setSize(x.width, x.height), [c2, x]), useFrame((C2, R) => {
    if (a) {
      const E = d.autoClear;
    ...
    if (R && c2) {
      ...
      for (let T2 = 0; T2 < E.length; T2++) {
        ...
        if (N instanceof Effect) {
          ...
          if (!ie(N)) {
            let G = null;
            for (; (G = (_a = E[T2 + 1]) == null ? void 0 : _a.object) instanceof Effect && !ie(G); ) q.push(G), T2++;
          }
          const $ = new EffectPass(u, ...q);
          C2.push($);
        } else N instanceof Pass && C2.push(N);
      }
      for (const T2 of C2) c2 == null ? void 0 : c2.addPass(T2);
      U && (U.enabled = true), b && (b.enabled = true);
    }
    return () => {
      for (const E of C2) c2 == null ? void 0 : c2.removePass(E);
...
var P2 = (e, t) => function({ blendFunction: o = t == null ? void 0 : t.blendFunction, opacity: r = t == null ? void 0 : t.opacity, ...a }) {
  let n = le.get(e);
  if (!n) {
...
var ce = (0, import_react.forwardRef)(function({ blendFunction: e, worldFocusDistance: t, worldFocusRange: o, focusDistance: r, focusRange: a, focalLength: n, bokehScale: i, resolutionScale: s, resolutionX: l, resolutionY: p2, width: _, height: S, target: g, depthTexture: d, ...m2 }, v4) {
  ...
  return (0, import_react.useEffect)(() => () => {
    u.dispose();
  }, [u]), (0, import_jsx_runtime.jsx)("primitive", { ...m2, ref: v4, object: u, target: g });
});
var ht = (0, import_react.forwardRef)(({ target: e = void 0, mouse: t = false, debug: o = void 0, manual: r = false, smoothTime: a = 0.25, ...n }, i) => {
  const s = (0, import_react.useRef)(null), l = (0, import_react.useRef)(null), p2 = (0, import_react.useRef)(null), _ = useThree(({ scene: b }) => b), S = useThree(({ pointer: b }) => b), { composer: g, camera: d } = (0, import_react.useContext)(D), [m2] = (0, import_react.useState)(() => new DepthPickingPass()), [v4] = (0, import_react.useState)(() => new CopyPass());
  (0, import_react.useEffect)(() => (g.addPass(m2), g.addPass(v4), () => {
    g.removePass(m2), g.removePass(v4);
  }), [g, m2, v4]), (0, import_react.useEffect)(() => () => {
    m2.dispose(), v4.dispose();
  }, [m2, v4]);
  ...
  useFrame(async (b, F) => {
    var _a;
    r || c2(F), l.current && l.current.position.copy(x), p2.current && ((_a = s.current) == null ? void 0 : _a.target) && p2.current.position.copy(s.current.target);
  });
...
var fe = class extends Effect {
  constructor({ blendFunction: t, enabled: o, glareSize: r, lensPosition: a, screenRes: n, starPoints: i, flareSize: s, flareSpeed: l, flareShape: p2, animated: _, anamorphic: S, colorGain: g, lensDirtTexture: d, haloScale: m2, secondaryGhosts: v4, aditionalStreaks: x, ghostScale: f, opacity: u, starBurst: c2 }) {
    super("LensFlareEffect", _t.fragmentShader, { blendFunction: t, uniforms: /* @__PURE__ */ new Map([["enabled", new Uniform(o)], ["glareSize", new Uniform(r)], ["lensPosition", new Uniform(a)], ["time", new Uniform(0)], ["screenRes", new Uniform(n)], ["starPoints", new Uniform(i)], ["flareSize", new Uniform(s)], ["flareSpeed", new Uniform(l)], ["flareShape", new Uniform(p2)], ["animated", new Uniform(_)], ["anamorphic", new Uniform(S)], ["colorGain", new Uniform(g)], ["lensDirtTexture", new Uniform(d)], ["haloScale", new Uniform(m2)], ["secondaryGhosts", new Uniform(v4)], ["aditionalStreaks", new Uniform(x)], ["ghostScale", new Uniform(f)], ["starBurst", new Uniform(c2)], ["opacity", new Uniform(u)]]) });
  }
  update(t, o, r) {
...
var gt = ({ smoothTime: e = 0.07, blendFunction: t = 23, enabled: o = true, glareSize: r = 0.2, lensPosition: a = new Vector3(-25, 6, -60), screenRes: n = new Vector2(0, 0), starPoints: i = 6, flareSize: s = 0.01, flareSpeed: l = 0.01, flareShape: p2 = 0.01, animated: _ = true, anamorphic: S = false, colorGain: g = new Color(20, 20, 20), lensDirtTexture: d = null, haloScale: m2 = 0.5, secondaryGhosts: v4 = true, aditionalStreaks: x = true, ghostScale: f = 0, opacity: u = 1, starBurst: c2 = false }) => {
  ...
  }, [U]), (0, import_jsx_runtime.jsx)(xt, { ref: E, blendFunction: t, enabled: o, glareSize: r, lensPosition: a, screenRes: n, starPoints: i, flareSize: s, flareSpeed: l, flareShape: p2, animated: _, anamorphic: S, colorGain: g, lensDirtTexture: d, haloScale: m2, secondaryGhosts: v4, aditionalStreaks: x, ghostScale: f, opacity: u, starBurst: c2 });
};
...
var Bt = (0, import_react.forwardRef)(function({ selection: e = [], selectionLayer: t = 10, blendFunction: o, patternTexture: r, edgeStrength: a, pulseSpeed: n, visibleEdgeColor: i, hiddenEdgeColor: s, width: l, height: p2, kernelSize: _, blur: S, xRay: g, ...d }, m2) {
  const v4 = useThree((U) => U.invalidate), { scene: x, camera: f } = (0, import_react.useContext)(D), u = (0, import_react.useMemo)(() => new OutlineEffect(x, f, { blendFunction: o, patternTexture: r, edgeStrength: a, pulseSpeed: n, visibleEdgeColor: i, hiddenEdgeColor: s, width: l, height: p2, kernelSize: _, blur: S, xRay: g, ...d }), [o, S, f, a, p2, s, _, r, n, x, i, l, g]), c2 = (0, import_react.useContext)(H);
  return (0, import_react.useEffect)(() => {
    if (!c2 && e) return u.selection.set(Array.isArray(e) ? e.map(k) : [k(e)]), v4(), () => {
      u.selection.clear(), v4();
    };
  }, [u, e, c2, v4]), (0, import_react.useEffect)(() => {
    u.selectionLayer = t, v4();
  }, [u, v4, t]), (0, import_react.useRef)(void 0), (0, import_react.useEffect)(() => {
    var _a;
    if (c2 && c2.enabled && ((_a = c2.selected) == null ? void 0 : _a.length)) return u.selection.set(c2.selected), v4(), () => {
      u.selection.clear(), v4();
    };
  }, [c2, u.selection, v4]), (0, import_react.useEffect)(() => () => {
    u.dispose();
...
var kt = (0, import_react.forwardRef)(function({ selection: e = [], selectionLayer: t = 10, lights: o = [], inverted: r = false, ignoreBackground: a = false, luminanceThreshold: n, luminanceSmoothing: i, intensity: s, width: l, height: p2, kernelSize: _, mipmapBlur: S, ...g }, d) {
  ...
  const m2 = useThree((c2) => c2.invalidate), { scene: v4, camera: x } = (0, import_react.useContext)(D), f = (0, import_react.useMemo)(() => {
    const c2 = new SelectiveBloomEffect(v4, x, { blendFunction: 0, luminanceThreshold: n, luminanceSmoothing: i, intensity: s, width: l, height: p2, kernelSize: _, mipmapBlur: S, ...g });
    return c2.inverted = r, c2.ignoreBackground = a, c2;
  }, [v4, x, n, i, s, l, p2, _, S, r, a, g]), u = (0, import_react.useContext)(H);
  return (0, import_react.useEffect)(() => {
    ...
    var _a;
    if (u && u.enabled && ((_a = u.selected) == null ? void 0 : _a.length)) return f.selection.set(u.selected), m2(), () => {
      f.selection.clear(), m2();
    };
...
var ao = (0, import_react.forwardRef)(({ halfRes: e, screenSpaceRadius: t, quality: o, depthAwareUpsampling: r = true, aoRadius: a = 5, aoSamples: n = 16, denoiseSamples: i = 4, denoiseRadius: s = 12, distanceFalloff: l = 1, intensity: p2 = 1, color: _, renderMode: S = 0 }, g) => {
  const { camera: d, scene: m2 } = useThree(), v4 = (0, import_react.useMemo)(() => new $87431ee93b037844$export$2489f9981ab0fa82(m2, d), [d, m2]);
  return (0, import_react.useLayoutEffect)(() => {
    applyProps(v4.configuration, { color: _, aoRadius: a, distanceFalloff: l, intensity: p2, aoSamples: n, denoiseSamples: i, denoiseRadius: s, screenSpaceRadius: t, renderMode: S, halfRes: e, depthAwareUpsampling: r });
  }, [t, _, a, l, p2, n, i, s, S, e, r, v4]), (0, import_react.useLayoutEffect)(() => {
    o && v4.setQualityMode(o.charAt(0).toUpperCase() + o.slice(1));
  }, [v4, o]), (0, import_jsx_runtime.jsx)("primitive", { ref: g, object: v4 });
});
export {
  eo as ASCII,
  ht as Autofocus,
